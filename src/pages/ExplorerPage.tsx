...
const CAT_ICONS: Record<string, string> = {
  ...
  'Aviation Cockpit': 'M21 16v-2l-8-5V3.5c0-.83-.67-1.5-1.5-1.5S10 2.67 10 3.5V9l-8 5v2l8-2.5V19l-2 1.5V22l3.5-1 3.5 1v-1.5L13 19v-5.5l8 2.5z',
  Submarine: 'M20 18H4v-1h16v1zm-1.5-4c.28 0 .5.22.5.5s-.22.5-.5.5-.5-.22-.5-.5.22-.5.5-.5M20 11c-1.5 0-2.6.71-3.36 1.43C15.88 11.71 14.78 11 13.28 11c-1.5 0-2.6.71-3.36 1.43C9.16 11.71 8.06 11 6.56 11 5.06 11 3.96 11.71 3.2 12.43 2.44 11.71 1.5 11 0 11v2c.83 0 1.45.39 2 .78V16h20v-2.22c.55-.39 1.17-.78 2-.78v-2c-1.5 0-2.44.71-3.2 1.43-.76-.72-1.86-1.43-3.36-1.43-.28 0-.5.22-.5.5s.22.5.5.5z',
  'Vintage HiFi': 'M12 3v9.28c-.47-.17-.97-.28-1.5-.28C8.01 12 6 14.01 6 16.5S8.01 21 10.5 21c2.31 0 4.2-1.75 4.45-4H15V6h4V3h-7zM10.5 19c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z',
  Watchmaking: 'M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm.5-13H11v6l5.25 3.15.75-1.23-4.5-2.67z',
  ...
  'Oscilloscope & Lab': 'M7 5h10v2h2V3c0-1.1-.9-2-2-2H7c-1.1 0-2 .9-2 2v4h2V5zm8.41 11.59L20 12v9c0 1.1-.9 2-2 2H7c-1.1 0-2-.9-2-2v-9l4.59 4.59c.78.78 2.05.78 2.83 0L15.41 16.59zM12 14l4-4h-3V5h-2v5H8l4 4z',
  'Weather Station': 'M6.76 4.84l-1.8-1.79-1.41 1.41 1.79 1.79 1.42-1.41zM4 10.5H1v2h3v-2zm9-9.95h-2V3.5h2V.55zm7.45 3.91l-1.41-1.41-1.79 1.79 1.41 1.41 1.79-1.79zm-3.21 13.7l1.79 1.8 1.41-1.41-1.8-1.79-1.4 1.4zM20 10.5v2h3v-2h-3zm-8-5c-3.31 0-6 2.69-6 6s2.69 6 6 6 6-2.69 6-6-2.69-6-6-6zm-1 16.95h2V19.5h-2v2.95zm-7.45-3.91l1.41 1.41 1.79-1.8-1.41-1.41-1.79 1.8z',
  'Steam & Mechanical': 'M19.88 18.47c.44-.7.7-1.51.7-2.39 0-2.49-2.01-4.5-4.5-4.5s-4.5 2.01-4.5 4.5 2.01 4.5 4.5 4.5c.88 0 1.69-.26 2.39-.7L22.59 24 24 22.59l-4.12-4.12zm-3.8.11c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5zM12 20v2C6.48 22 2 17.52 2 12S6.48 2 12 2s10 4.48 10 10c0 1.1-.18 2.16-.51 3.15-.55-.3-1.14-.5-1.78-.62.19-.8.29-1.64.29-2.53 0-4.42-3.58-8-8-8s-8 3.58-8 8 3.58 8 8 8z',
  'Printing & Typography': 'M19 8H5c-1.66 0-3 1.34-3 3v6h4v4h12v-4h4v-6c0-1.66-1.34-3-3-3zm-3 11H8v-5h8v5zm3-7c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1zm-1-9H6v4h12V3z',
  'Vintage Computing': 'M20 18c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2H4c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2H0v2h24v-2h-4zM4 6h16v10H4V6z',
};
